      ...
      <div className="flex justify-end items-center">
        <div className="space-x-2 flex">
          ...
          <a href={value.url}>
            ...
            <button className="max500:show min500:hidden  whitespace-nowrap flex items-center rounded-md bg-blue hover:bg-[#1b9dbd] text-white text-xxs lg:text-xs font-medium p-2">
